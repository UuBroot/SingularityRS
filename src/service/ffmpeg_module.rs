...
const SUPPORTED_FORMATS: [&str; 74] = [
    ...
    "dds_pipe", "dfpwm", "dvd", "eac3", "f4v", "fits", "flv", "g722", "genh", "gif", "h264",
    "hevc", "ircam", "ismv", "ivf", "latm", "loas", "m4v", "mjpeg", "moflex", "m4a", "mp2", "mp3",
...
fn get_percentage(line: &str, total_frames: &u64) -> f64 {
    let current_frame = line.split('=').collect::<Vec<&str>>()[1]
        .parse::<i32>()
        .unwrap();
